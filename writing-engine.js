...
const WritingEngine = {
    ...
    renderMenu: function() {
        ...
        <div class="fade-in">
            ...
            <div onclick="alert('Coming in the next batch!')" style="background:white; padding:20px; border-radius:24px; margin-bottom:15px; box-shadow:0 10px 30px rgba(0,0,0,0.04); cursor:pointer; display:flex; align-items:center; gap:20px; opacity:0.6;">
                ...
                <div>
                    ...
                    <p style="margin:5px 0 0; font-size:13px; color:#64748b; font-weight:600;">15 Marks</p>
                </div>
