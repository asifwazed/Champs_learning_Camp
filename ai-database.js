...
const miniChampBrain = [
    ...
    // ==========================================
    // 🚀 THE ULTIMATE EXPANSION PACK (NEW ADDITIONS)
    // ==========================================

    // --- 21. ELITE GRAMMAR: CAUSATIVE VERBS ---
    ...
    // --- 22. ELITE GRAMMAR: THE SUBJUNCTIVE MOOD ---
    ...
    { triggers: ["it is important that", "it is essential that", "subjunctive adjectives"], reply: "🔥 **Subjunctive Adjectives:**<br>Phrases like 'It is essential that', 'It is crucial that', or 'It is vital that' also take the pure **Base Verb**. <br>Example: *It is essential that she **be** present at the meeting.* (NOT is/should be!)." },

    // --- 23. ELITE GRAMMAR: INVERSIONS (REVERSE ORDER) ---
    ...
    { triggers: ["not only but also", "not only inversion"], reply: "🔄 **Inversion with 'Not Only':**<br>If 'Not only' is at the beginning of a sentence, invert the first part! <br>Example: *Not only **did he** code the app, but he also designed the database.*" },

    // --- 24. HSC WRITING VAULT: ADVANCED FORMATS ---
    ...
    { triggers: ["memo writing", "memorandum", "how to write a memo"], reply: "📋 **Memo (Memorandum) Format:**<br>Use a box. At the top left write:<br>**TO:** [Target Audience]<br>**FROM:** [Your Name/Title]<br>**DATE:** [Date]<br>**SUBJECT:** [Short topic]<br>Then write a short, direct message. No 'Dear Sir' or 'Yours faithfully' needed!" },

    // --- 25. VARSITY ADMISSION: HARDCORE SPELLING HACKS ---
    { triggers: ["spelling of lieutenant", "lieutenant spelling"], reply: "✍️ **Spelling Hack: Lieutenant**<br>Remember this funny phrase: *Lie - u - ten - ant* (মিথ্যা - তুমি - দশ - পিঁপড়া). <br>Spelling: **L - I - E - U - T - E - N - A - N - T**." },
    { triggers: ["spelling of assassination", "assassination spelling"], reply: "✍️ **Spelling Hack: Assassination**<br>Remember: *Ass - ass - i - nation* (গাধা - গাধা - আমি - জাতি). <br>Spelling: **A - S - S - A - S - S - I - N - A - T - I - O - N**." },
    { triggers: ["spelling of bureaucracy", "bureaucracy spelling"], reply: "✍️ **Spelling Hack: Bureaucracy**<br>Break it down: *Bureau - cracy*. <br>Spelling: **B - U - R - E - A - U - C - R - A - C - Y**." },
    { triggers: ["spelling of millennium", "millennium spelling"], reply: "✍️ **Spelling Hack: Millennium**<br>It has DOUBLE 'L' and DOUBLE 'N'! <br>Spelling: **M - I - L - L - E - N - N - I - U - M**." },
    { triggers: ["spelling of psychology", "psychology spelling"], reply: "✍️ **Spelling Hack: Psychology**<br>The 'P' is silent! Think: *Psy - cho - logy*. <br>Spelling: **P - S - Y - C - H - O - L - O - G - Y**." },

    // --- 26. GRE / BARRON'S VOCABULARY (ADMISSION CHEAT SHEET) ---
    { triggers: ["abate", "meaning of abate"], reply: "📚 **Varsity Vocab: Abate (Verb)**<br>Meaning: To become less intense or widespread.<br>Example: *The storm suddenly abated.*<br>Synonyms: Subside, Decrease, Diminish." },
    { triggers: ["cacophony", "meaning of cacophony"], reply: "📚 **Varsity Vocab: Cacophony (Noun)**<br>Meaning: A harsh, confusing mixture of sounds.<br>Example: *The traffic jam in Dhaka creates a terrible cacophony.*<br>Synonyms: Noise, Clatter, Discord." },
    { triggers: ["enigma", "meaning of enigma"], reply: "📚 **Varsity Vocab: Enigma (Noun)**<br>Meaning: A person or thing that is mysterious, puzzling, or difficult to understand.<br>Example: *How Asif coded this entire engine alone remains an enigma.*<br>Synonyms: Mystery, Puzzle, Riddle." },
    { triggers: ["ephemeral", "meaning of ephemeral"], reply: "📚 **Varsity Vocab: Ephemeral (Adjective)**<br>Meaning: Lasting for a very short time.<br>Example: *Fame on the internet is often ephemeral.*<br>Synonyms: Temporary, Short-lived, Transient." },
    { triggers: ["gregarious", "meaning of gregarious"], reply: "📚 **Varsity Vocab: Gregarious (Adjective)**<br>Meaning: Fond of company; sociable.<br>Example: *She is a gregarious person who loves attending parties.*<br>Synonyms: Sociable, Outgoing, Extroverted." },
    { triggers: ["lucid", "meaning of lucid"], reply: "📚 **Varsity Vocab: Lucid (Adjective)**<br>Meaning: Expressed clearly; easy to understand.<br>Example: *Mini Champ provides lucid explanations of complex grammar.*<br>Synonyms: Clear, Comprehensible, Intelligible." },
    { triggers: ["mitigate", "meaning of mitigate"], reply: "📚 **Varsity Vocab: Mitigate (Verb)**<br>Meaning: To make something less severe, harmful, or painful.<br>Example: *We need to plant trees to mitigate the effects of global warming.*<br>Synonyms: Alleviate, Reduce, Lessen." },

    // --- 27. ADVANCED SPOKEN ENGLISH: PROFESSIONAL DIPLOMACY ---
    { triggers: ["how to say no to boss", "decline extra work"], reply: "👔 **Workplace Survival: Saying 'No' to extra work:**<br>Never say 'I won't do it.' Say:<br>- *'I would love to help, but my plate is completely full right now.'*<br>- *'If I take this on, it will compromise the quality of my current project.'*<br>- *'Can we prioritize my tasks? Which one should I drop to do this?'*" },
    { triggers: ["how to ask for help", "requesting help professionally"], reply: "🤝 **Workplace Survival: Asking for Help:**<br>- *'Do you have the bandwidth to assist me with this?'*<br>- *'I could really use your expertise on this matter.'*<br>- *'I am facing a roadblock, could I get your perspective?'*" },
    { triggers: ["how to politely disagree", "professional disagreement"], reply: "🛑 **Workplace Survival: Disagreeing in Meetings:**<br>- *'I understand where you are coming from, but I have a slightly different view.'*<br>- *'That is a valid point, however, the data suggests otherwise.'*<br>- *'Let me play devil's advocate for a moment...'* " },
    { triggers: ["how to end a meeting", "wrap up meeting"], reply: "🏁 **Workplace Survival: Wrapping up a meeting:**<br>- *'I want to be respectful of everyone's time, so let's wrap this up.'*<br>- *'To summarize our action items for today...'*<br>- *'Let's circle back to this discussion next week.'*" },

    // --- 28. THE ENGINE, ASIF, & SHA (EXTENDED LORE) ---
    { triggers: ["how does the ui work", "who made the glassmorphism", "ui design details"], reply: "🎨 **The Design Philosophy:** The UI of Champ's Camp is built on a concept called 'Glassmorphism'—frosted glass panels over dark, neon gradients. This visionary aesthetic was conceptualized by Sha! She acts as the creative compass, ensuring Asif's raw code turns into an incredibly beautiful, user-friendly experience." },
    { triggers: ["what is hybrid rag", "how does mini champ work", "ai engine details"], reply: "⚙️ **The Hybrid RAG Engine:** My brain uses Retrieval-Augmented Generation! That means Asif hard-coded thousands of specific HSC rules directly into my local memory (like this response!). When you ask a question, I scan Asif's database *first*. If I can't find it, I seamlessly connect to Google's cloud to fetch the answer. It makes me lightning fast and hyper-accurate!" },
    { triggers: ["how long did it take to build", "development time"], reply: "⏳ **The Build Process:** Rome wasn't built in a day, and neither was Champ's Camp! Asif poured countless late nights, hundreds of cups of coffee, and intense focus into engineering this. With Sha providing continuous UI inspiration and support, the platform evolved from a simple concept into the most advanced free HSC engine in Bangladesh." },

    // --- 29. DAILY MOTIVATION & PSYCHOLOGY (PART 2) ---
    { triggers: ["i want to give up", "giving up", "too hard"], reply: "🛑 **Wait.** Don't close the book yet. It feels impossible because you are standing at the bottom of the mountain looking at the peak. Stop looking at the peak. Look at your feet. Just take ONE step today. Memorize ONE rule. Tomorrow, take another. Asif built this app so you wouldn't have to climb alone. I am right here with you. Take a breath, and let's do this." },
    { triggers: ["i feel sleepy when i study", "how to not sleep while studying"], reply: "😴 **The Sleepy Student Hack:** <br>1. NEVER study on your bed. Your brain associates the bed with sleep.<br>2. Sit at a desk with a straight back.<br>3. Drink cold water.<br>4. Read out loud! If you speak the words using the Read-Aloud feature or Voice Lab, your brain is forced to stay awake." },
    { triggers: ["how to study english fast", "fastest way to learn english"], reply: "⚡ **The 80/20 Rule (Pareto Principle):** You don't need to know every word in the dictionary to be fluent. 20% of English vocabulary makes up 80% of daily conversations. Focus entirely on the Spoken Hub scenarios and the Grammar Matrix formulas. Ignore the useless rules!" },
    { triggers: ["i am confused about my future", "career advice", "what should i do after hsc"], reply: "🧭 **Future Focus:** It's okay not to have it all figured out! Right now, your only job is to unlock doors. Good HSC results and strong English fluency are 'Master Keys'—they open doors to Medical, Engineering, University, and studying abroad. Build the skills now, pick the door later!" }
];
